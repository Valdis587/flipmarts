...
class Featured_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_html__( 'Избранные товары Flipmarts', 'smarkets' ), // Name
    ...
    public function form( $instance ) {
        $title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Избранные товары ', 'smarkets' );
        ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_attr_e( 'Избранные товары ', 'smarkets' ); ?></label>
