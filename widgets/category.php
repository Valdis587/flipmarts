...
class Caregory_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_html__( 'Категории Flipmarts', 'smarkets' ), // Name
    ...
    public function widget( $args, $instance )
    {
        ...
        <ul class="sidebar__wiget-category-list">
                    <?php
                    ...
                    if($terms) {
                        foreach($terms as $term) {
                            ...
                            if($children_terms) { ?>
                                <li class="sub-list"><a href="javascript:void(0);"><?php echo $term->name;?><i class="icon-angle-down"></i></a>
                                    <ul class="sub-cat-list">
                                        <?php foreach ($children_terms as $children_term) { ?>
                                            <li><a  href="<?php echo get_category_link($children_term->term_id);?>"><?php echo $children_term->name; ?></a></li>
                                        <?php } ?>
                                    </ul>
                                </li>
                            <?php } else { ?>
