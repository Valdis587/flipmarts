...
function theme_popup_quick_view_callback() {
    ...
    while ( have_posts() ) :
        the_post();
    ?>
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( ' single-product-row', $product ); ?>>
    <div class="single-product-column">
    <div class="single-product-images shop__pop-img">
        <?php do_action( 'woocommerce_before_single_product_summary' ); ?>
    </div>
    <div class="summary entry-summary shop__pop-summary">
