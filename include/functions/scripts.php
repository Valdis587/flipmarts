...
function woo_scripts() {
	...
	wp_enqueue_style('assets-style', get_template_directory_uri() . '/assets/css/style.min.css', array(), _S_VERSION);
	...
	wp_enqueue_script( 'owl-js', get_template_directory_uri() . '/assets/js/owl.carousel.min.js', array(), _S_VERSION, true );
	...
	wp_enqueue_script( 'woo-js', get_template_directory_uri() . '/assets/js/woo.min.js', array(), _S_VERSION, true );

	wp_enqueue_script( 'assets-js', get_template_directory_uri() . '/assets/js/scripts.min.js', array(), _S_VERSION, true );
