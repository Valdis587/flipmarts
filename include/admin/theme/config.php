...
$opt_name = 'themesetting';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Настройки темы', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Настройки темы', 'your-textdomain-here' ),
...
/*
 * ---> START THEME SECTIONS
 */

 Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Общие настройки', 'your-textdomain-here' ),
		'id'               => 'basic-theme',
		'customizer_width' => '400px',
		'icon'             => 'el el-cogs',
	)
);
require_once Redux_Core::$dir . '../theme/basic-theme/colortheme.php';
require_once Redux_Core::$dir . '../theme/basic-theme/logo.php';
require_once Redux_Core::$dir . '../theme/basic-theme/contacts.php';
require_once Redux_Core::$dir . '../theme/basic-theme/metrika.php';
require_once Redux_Core::$dir . '../theme/basic-theme/pagehead.php';
...
require_once Redux_Core::$dir . '../theme/footer/footer.php';
require_once Redux_Core::$dir . '../theme/footer/paypal.php';
...
require_once Redux_Core::$dir . '../theme/page/onas.php';
...
require_once Redux_Core::$dir . '../theme/home/sections.php';
require_once Redux_Core::$dir . '../theme/home/home-slider.php';
require_once Redux_Core::$dir . '../theme/home/last-prod.php';
require_once Redux_Core::$dir . '../theme/home/sale-prod.php';
require_once Redux_Core::$dir . '../theme/home/new-prod.php';
require_once Redux_Core::$dir . '../theme/home/hit-prod.php';
require_once Redux_Core::$dir . '../theme/home/action-prod.php';
require_once Redux_Core::$dir . '../theme/home/featured-prod.php';
require_once Redux_Core::$dir . '../theme/home/category.php';
require_once Redux_Core::$dir . '../theme/home/banner.php';
require_once Redux_Core::$dir . '../theme/home/banner2.php';
require_once Redux_Core::$dir . '../theme/home/faq.php';
require_once Redux_Core::$dir . '../theme/home/blog.php';
require_once Redux_Core::$dir . '../theme/home/logo.php';

 Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Магазин', 'your-textdomain-here' ),
		'id'               => 'shop',
		'customizer_width' => '400px',
		'icon'             => 'el el-shopping-cart-sign',
	)
);
require_once Redux_Core::$dir . '../theme/shop/badges.php';
require_once Redux_Core::$dir . '../theme/shop/quick.php';
require_once Redux_Core::$dir . '../theme/shop/count.php';
require_once Redux_Core::$dir . '../theme/shop/carusel-cat.php';
require_once Redux_Core::$dir . '../theme/shop/message.php';

 require_once Redux_Core::$dir . '../theme/productbox.php';
 require_once Redux_Core::$dir . '../theme/font.php';
/*
 * ---> END THEME SECTIONS
 */
